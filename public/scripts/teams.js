        ...
        function createTeamTable() {
            ...
            $.getJSON(
                ...
                function(data) {
                    objs = data;
                    $("#teamTableHead").empty();
                    let markupHeader = "<tr><th>Organization Type</th><th>Team Type</th><th>Team Gender</th><th>Team Name</th><th>View/Edit</th></tr>";
                    ...
                    for (let i = 0; i < objs.length; i++) {
                        ...
                        let markupBody = "<tr><td>" + objs[i].League + "</td><td>" + objs[i].TeamType + "</td><td>" + objs[i].TeamGender + "</td><td>" + objs[i].TeamName + "</td><td><a class='mr-2' title='View' href=" + url + "><i class='fas fa-binoculars fa-lg' aria-hidden='true'></i></a><a class='edit mr-2' title='Edit' href=" + urledit + "><i class='fa fa-pencil-alt fa-lg' aria-hidden='true'></i></a></td></tr>";
